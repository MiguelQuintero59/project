...
# 000 - USEFUL COMPONENTS AS FUNCTIONS
# Header with logo
def get_header():
    header = html.Div([
...
def get_navbar(p='airbnb'):
    navbar_sales = html.Div([
        ...
        html.Div([
            dcc.Link(
                html.H4(children='Airbnb Overview',
                        style=navbarcurrentpage),
                href='/apps/airbnb-overview'
            )
        ],
            className='col-2'),
        ...
        html.Div([  # External 12-column
            ...
            html.Div([  # Internal row
                ...
                html.Div([
                    ...
                    html.Div([
                        html.H5(
                            children='Filters by Room Property Type:',
                            style={'text-align': 'left', 'color': corporate_colors['dark-grey']}
                        ),
    ...
    html.Div([  # External row
        ...
        html.Div([  # External 10-column important one
            ...
            html.Div([  # Internal row
                ...
                html.Div([
                    html.Img(
                        id='image_wc', style={'width': '40vh', 'height': '40vh'})
                ],
                    className='col-4')
